...
use umeng\notification\andriod\AndroidBroadcast;
use umeng\notification\andriod\AndroidUnicast;
use umeng\notification\andriod\AndroidCustomizedcast;
use umeng\notification\andriod\AndroidFilecast;
use umeng\notification\andriod\AndroidGroupcast;
...
class Demo
{
    ...
    function sendAndroidUnicast()
    {
        try {
            ...
            $unicast->setPredefinedKeyValue("device_tokens", "AsREPA2P-Lf3GWwYQzp510XnzjDZ0Qze5Zn65Yf74Nhp");
